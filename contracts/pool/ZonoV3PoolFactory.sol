...
// File: contracts/ZonoV3Pool.sol

pragma solidity 0.6.12;

contract ZonoV3Pool is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
...
contract ZonoPoolFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(ZonoV3Pool).creationCode;
        ...
        ZonoV3Pool(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
