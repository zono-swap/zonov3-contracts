...
contract ZonoGodNFT is ERC721A, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    uint256 public _nftPrice = 0.13 ether; // NFT price in ETH
    uint256 public _maxSupply = 980;
    ...
    constructor() ERC721A("ZONO GOD", "ZNG") {}
